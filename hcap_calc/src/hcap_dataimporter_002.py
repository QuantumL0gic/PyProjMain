...
##############################################################################
def import_scores(datapath, score_file, score_inf):
    score_dat = pd.read_csv(datapath+score_file)
...
def import_courseinfo(datapath, course_file, course_inf):
    course_dat = pd.read_csv(datapath+course_file)
